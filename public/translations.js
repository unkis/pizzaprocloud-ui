wpa.translations = (function() {
  function TranslateInnerSpanish(str) {
    try {
      ...
      if (str === 'init encryption. please wait...')
        return 'Iniciando encriptaciуn. Por favor espere...'
      if (str === 'sound device test failed')
        return 'Test sobre el dispositivo de sonido ha fallado'
      if (str === 'Cannot open mic (audio in) device')
        return 'No puede abrir el micrуfono (entrada de audio)'
      if (str === 'Register expired') return 'El registro ha expirado'
      if (str === 'Register expired / Manual reregister needed')
        return 'Registro expirу / Necesita re-registro manual'
      ...
      if (str === 'Server is offline, your network is offline')
        return 'Servidor fuera de lнnea, su red esta desconectada'
      if (str === 'Wrong username/password, rejected by the server')
        return 'Nombre de usuario / contraseсa incorrectos, el servidor ha rechazado la conexiуn'
      if (str === 'Forbidden by the server -probably wrong username/password')
        return 'Conexiуn prohibida por el servidor - probablemente el nombre de usuario / contraseсa sea errуneo'
      ...
      if (str === 'no response for callsetup')
        return 'Ninguna respuesta para el establecimiento de llamada'
  ...
  function TranslateInnerHun(str) {
    try {
      ...
      if (str === 'Call rejected: service unavailable')
        return 'Hivбs elъtasitva: szolgбltatбs nemelйrhet\u0151'
      ...
      if (str === 'Save my settings on this computer locally (including password!)')
        return 'Mentse le beбllнtбsaimat ezen a szбmнtуgйpen (jelszуt beleйrtve)'
  ...
  function TranslateInnerRus(str) {
    try {
      ...
      if (str === 'Connecting')
        return '\u0412\u043E\u0439\u0442\u0438 \u0432 \u0441\u0435\u0442\u044C' //"\u0421\u043E\u0435\u0434\u0438\u043D\u0438\u0442\u044C\u0441\u044F";
      if (str === 'Hangup')
      ...
      if (str === 'Incoming call')
        return '\u0412\u0445\u043E\u0434\u044F\u0449\u0438\u0439 \u0437\u0432\u043E\u043D\u043E\u043A'
      if (str === 'Incoming call...')
        return '\u0412\u0445\u043E\u0434\u044F\u0449\u0438\u0439 \u0437\u0432\u043E\u043D\u043E\u043A'
      if (str === 'Incoming call from')
      ...
      if (str === 'Request Terminated')
        return '\u0417\u0430\u043F\u0440\u043E\u0441 \u043E\u0442\u043A\u043B\u043E\u043D\u0435\u043D'
      if (str === 'Not Acceptable Here')
        return '\u041D\u0435 \u043F\u0440\u0438\u043C\u0435\u043D\u0438\u043C\u043E'
      ...
      if (str === 'Your authentication username')
        return '\u0412\u0430\u0448 \u043B\u043E\u0433\u0438\u043D'
      ...
      if (str === 'Callback')
        return '\u041E\u0431\u0440\u0430\u0442\u043D\u044B\u0439 \u0432\u044B\u0437\u043E\u0432'
      if (str === 'invalid username')
        return '\u041D\u0435\u043F\u0440\u0430\u0432\u0438\u043B\u044C\u043D\u044B\u0439 \u043B\u043E\u0433\u0438\u043D'
      if (str === 'invalid password')
        return '\u041D\u0435\u043F\u0440\u0430\u0432\u0438\u043B\u044C\u043D\u044B\u0439 \u043F\u0430\u0440\u043E\u043B\u044C'
      if (str === 'invalid phonenumber')
        return '\u041D\u0435\u043F\u0440\u0430\u0432\u0438\u043B\u044C\u043D\u044B\u0439 \u043D\u043E\u043C\u0435\u0440'
      if (str === 'invalid number')
        return '\u041D\u0435\u043F\u0440\u0430\u0432\u0438\u043B\u044C\u043D\u044B\u0439 \u043D\u043E\u043C\u0435\u0440'
      if (str === 'Callback initiated')
  ...
  function TranslateInnerItalian(str) {
    try {
      ...
      if (str === 'Response Cannot Be Sent Safely')
        return 'La risposta non puт essere trasmessa in modo sicuro'
  ...
  function TranslateInnerPr(str) {
    try {
      ...
      if (str === 'Call rejected: service unavailable')
        return 'Chamada rejeitada: serviço indisponível'
      ...
      if (str === 'Response Cannot Be Sent Safely')
        return 'Resposta nгo pode ser Enviada com Seguranзa'
  ...
  function TranslateInnerTr(str) {
    try {
      ...
      if (str.indexOf('Starting VoIP engine') >= 0)
        return str.replace('Starting VoIP engine', 'VoIP motorubaşlatılıyor')
      if (str.indexOf('VoIP engine started') >= 0)
        return str.replace('VoIP engine started', 'VoIP motoru başlatıldı.')
      if (str === 'Finished') return 'Bitti'
      if (str.indexOf('Reason') >= 0) return str.replace('Reason', 'Neden')
      if (str.indexOf('Disconnect reason') >= 0)
        return str.replace('Disconnect reason', 'Bağlantı Kopma Sebebi')
  ...
  function TranslateInnerJp(str) {
    try {
      ...
      if (str === 'Proxy Authentication Required')
        return '\u30D7\u30ED\u30AD\u30B7\u8A8D\u8A3C\u304C\u5FC5\u8981\u3067\u3059'
      if (str === 'Request Timeout')
        return '\u30EA\u30AF\u30A8\u30B9\u30C8\u30BF\u30A4\u30E0\u30A2\u30A6\u30C8'
      if (str === 'Conflict') return '\u77DB\u76FE\u3057\u3066\u3044\u307E\u3059'
      if (str === 'Gone')
        return '\u8EE2\u9001\u5148\u30A2\u30C9\u30EC\u30B9\u304C\u4E0D\u660E\u3067\u3059'
      if (str === 'Conditional Request Failed')
        return '\u6761\u4EF6\u4ED8\u30EA\u30AF\u30A8\u30B9\u30C8\u304C\u5931\u6557\u3057\u307E\u3057\u305F'
      if (str === 'Request Entity Too Large')
        return '\u30EA\u30AF\u30A8\u30B9\u30C8\u306E\u30A8\u30F3\u30C6\u30A3\u30C6\u30A3\u304C\u5927\u304D\u3059\u304E\u307E\u3059'
      if (str === 'Request-URI Too Long')
        return '\u30EA\u30AF\u30A8\u30B9\u30C8\uFF35\uFF32\uFF29\u304C\u5927\u304D\u3059\u304E\u307E\u3059'
      if (str === 'Unsupported Media Type')
        return '\u30B5\u30DD\u30FC\u30C8\u3055\u308C\u306A\u3044\u30E1\u30C7\u30A3\u30A2\u30BF\u30A4\u30D7\u3067\u3059'
      if (str === 'Unsupported URI Scheme')
        return '\u30B5\u30DD\u30FC\u30C8\u3055\u308C\u306A\u3044\uFF35\uFF32\uFF29\u30B9\u30AD\u30FC\u30E0\u3067\u3059'
      ...
      if (str === 'Change speaker volume')
        return '\u30B9\u30D4\u30FC\u30AB\u30FC\u30DC\u30EA\u30E5\u30FC\u30E0\u306E\u5909\u66F4'
      if (str === 'Send instant message')
        return '\u30A4\u30F3\u30B9\u30BF\u30F3\u30C8\u30E1\u30C3\u30BB\u30FC\u30B8\u306E\u9001\u4FE1'
      ...
      if (str === 'Check credit')
        return '\u30AF\u30EC\u30B8\u30C3\u30C8\u3092\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044'
      if (str === 'ERROR') return '\u30A8\u30E9\u30FC'
      if (str === 'OK') return '\uFF2F\uFF2B'
      if (str === 'Call') return '\u767A\u4FE1'
      if (str === 'Too many requests')
        return '\u30EA\u30AF\u30A8\u30B9\u30C8\u304C\u591A\u3059\u304E\u307E\u3059'
      if (str === 'Too many wrong requests')
        return '\u8AA4\u3063\u305F\u30EA\u30AF\u30A8\u30B9\u30C8\u304C\u591A\u3059\u304E\u307E\u3059'
  ...
  function TranslateInnerFr(str) {
    try {
      ...
      if (str === 'Response Cannot Be Sent Safely')
        return 'La rйponse ne peut etre envoyйe de maniere securisйe'
      if (str === 'Requires congestion management')
        return "Necessitй d'un systeme de management de congestion"
      ...
      if (str === 'Save my settings on this computer locally (including password!)')
        return 'Sauver les donnйes localement(mot de passe inclu'
