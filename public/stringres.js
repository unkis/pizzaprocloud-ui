...
var stringres = (function() {
  var StringResources = {
    ...
    ie_update_it:
      'Questa applicazione richiede una nuova versione di Internet Explorer. Vuoi effettuare il download?',
    ...
    service_update_it:
      'Una nuova versione del plugin è disponibile. Si raccomanda di aggiornare appena possibile.',

    err_flash_local_it:
      'Il motore Flash funziona solo su un webserver pubblico, non su un file system locale',

    np_install_msg_it:
      'Avviare la installazione dopo il download.<br>Premere OK quando è stata completata.',
    ...
    no_contacts_2:
      'Or use the "Sync Contact" menu option to import contacts from your mobile.<br />(Sync will work only after you uploaded contacts from mobile device)',
    ...
    ie_update:
      'This application requires a higher version of Internet Explorer. Would you like to download and update ?',
    ...
    ce_enablejava:
      '<a href="https://java.com/en/download/help/enable_browser.xml" target="_blank">Enable java in your browser setting </a>',
    ce_install_java:
      'Or if you don\'t have java installed, install from <a href="https://java.com/download/" target="_blank">here.</a>',
    ...
    np_install_msg:
      'Please launch the installer once downloaded.<br>Click OK when install finished.',
    ...
    java_install:
      'Click OK to start downloading Java.<br>Login again after you have finished installing it.',
    ...
    add_to_home_msg:
      'You can create a shortcut on your Home Screen to [BRAND]. Tap on Menu/Bar icon in the top-right corner of your browser, then tap "Add to Home screen"',
    ...
    switch_confmessage:
      'To use the conference you need to install NS -Service Plugin. Just click OK to continue.',
    ...
    warning_feature:
      'You need to get a Pro license to enable this feature.<br />To activate license, login first, then select "License" from the menu.',
    ...
    allowmedia_general:
      'needs access to your microphone.<br />To grant access, click the sound/webrtc/microphone/camera/red icon in your browser and select Allow or Share, then remake the call.',
    ...
    chrome_local_alert:
      'The built-in WebRTC engine in the webphone will not work from local filesystem in Google Chrome or Opera browsers (only on HTTPS, from webservers with valid SSL certificate).\nIn these circumstances the webphone will be forced to use the NS or other engines if available. You can use Firefox if you wish to test the webphone WebRTC engine when launched from local file system.',
    chrome_local_webrtc_audio:
      'WebRTC does not have permission to access audio devices from local file system in Chrome and Opera browsers. \nThe webphone must be hosted on a secure webserver (HTTPS) to be able to make/receive calls using WebRTC.',
    ...
    chrome_https:
      'For Chrome and Opera we recommend to host the webphone on secure http (https), otherwise WebRTC will not work.',
    ...
    chrome_https_reload:
      'For Chrome and Opera the WebRTC will only work from secure http (https). \n\n Click OK to reload the page using mizu https proxy.',
    all_demo_msg:
      'Note: these messages are displayed only in demo version, in final build these situations are handled automatically',
    ...
    only_webrtc_engine1:
      'Only WebRTC engine is available in your browser but it is disabled in the webphone with the enginepriority_webrtc parameter',
    only_webrtc_engine2:
      'Only WebRTC engine is available in your browser but it is disabled in the webphone. Please contact your service provider.',
    only_ns_engine1:
      'Only Service plugin engine is available in your browser but it is disabled in the webphone with the enginepriority_ns parameter',
    only_ns_engine2:
      'Only Service plugin engine is available in your browser but it is disabled in the webphone. Please contact your service provider.',
    only_app_engine1:
      'Only App engine is available in your browser but it is disabled in the webphone with the enginepriority_app parameter',
    only_app_engine2:
      'Only App engine is available in your browser but it is disabled in the webphone. Please contact your service provider.',
    ...
    webcallme_msg:
      'Send this link to your friends and they will be able to call you with a simple click',
    ...
    service_update:
      'A new version of NS -Service Plugin is available. It is highly recommended to update to the latest version.',
    ...
    composing: 'is typing',
    logview_msg:
      'The page may not be available for a few seconds. Reload the page if nothing happens.',
    messagepl: 'Compose',
    ...
    request_permission:
      'Waiting for permission. Please push the Allow/Share button in your browser. Click on the webrtc/microphone/camera/red icon if you do not see the dialog.',
    warning_msg_1:
      'Only direct calls to SIP URIs will be possible if the VoIP Server address is not set',
    warning_msg_2:
      'IP or domain name is not accepted in this version. Enter server name or ID here.',
    warning_msg_3: "Please enter the contact's name",
    warning_msg_4:
      "Failed retrieving configurations.<br /><br /> On Settings page Server input, enter your VoIP provider's domain name or IP address",
    ...
    chrome_ext_install:
      'Before using Screen sharing, the Chrome extension from the below link needs to be installed.',
    ...
    sett_comment_serveraddress_user:
      'Enter server adress (domain or IP:port), brand-name or op-code here',
    ...
    sett_comment_startonboot:
      'Always listen for incoming calls (service will run in backround to enable incoming calls)',
    ...
    sett_comment_register:
      'Register to domain. This is always needed to receive incoming calls and some providers require also to allow outgoing calls.',
    ...
    sett_comment_proxyaddress:
      'Outbound SIP proxy address. Leave it empty if you don’t have a stateless/outbound proxy',
    ...
    sett_comment_voicemailnum:
      'Set voicemail number which will be used if not received automatically',
    sett_comment_short_voicemailnum: 'Set voicemail access number',

    sett_display_name_use_stun: 'Use STUN',
    sett_comment_use_stun:
      "Change if you have NAT related issues (can't register, can't call, no voice problems)",
    sett_comment_short_use_stun: 'Enable external address discovery',

    sett_display_name_use_fast_ice: 'Use ICE',
    sett_comment_use_fast_ice:
      'Fast ICE negotiations (for p2p rtp routing).<br />Note: if set to "Auto" or "Yes" then STUN should not be disabled',
    ...
    sett_comment_volumein:
      'Set default microphone volume between 0 and 100%. 50 means no volume changes.',
    sett_comment_short_volumein: '',

    sett_display_name_volumeout: 'Volume out',
    sett_comment_volumeout:
      'Set default speaker volume between 0 and 100%. 50 means no volume changes.',
    ...
    sett_comment_calltimeout:
      'Maximum speech time allowed in seconds. Default is 10800 seconds which means 3 hours',
    ...
    sett_comment_username:
      'This will not be used for authentication. Specify your User or extension ID here if not the same as Username for authentication setting. Some VoIP servers will reject if not the same with the username!',
    sett_comment_short_username:
      'You might set a different username here used for A number display',

    sett_display_name_displayname: 'Display name',
    sett_comment_displayname:
      'Specify display name. This is an optional setting and it should be your full name',
    ...
    sett_comment_keepaliveival:
      'NAT keep-alive packet send interval in milliseconds. Set to 0 to disable.',
    ...
    sett_comment_signalingport:
      'Specify local IP address signaling port to use (default is a stable port initialized with a random value. This has nothing to do with the server SIP port which is usually 5060)',
    sett_comment_short_signalingport: 'Optionally specify local signaling port to use',

    sett_display_name_rtpport: 'Local RTP port',
    sett_comment_rtpport:
      'Specify local RTP port base (default is a stable port base initialized with a random value)',
    sett_comment_short_rtpport: 'Specify local RTP port base',

    sett_display_name_jittersize: 'Jitter size',
    sett_comment_jittersize:
      'The jitter buffer is used for smooth playback under variable bandwidth. The size is calculated dynamically, but its behavior can modified with this setting',
    sett_comment_short_jittersize: '',

    sett_display_name_forcewifi: 'Force WiFi',
    sett_comment_forcewifi:
      '(Re)Enable and scan WiFi on startup, new call or connection lost (Even without this setting, WiFi will be the preferred when available)',
    ...
    sett_comment_callforwardonbusy:
      'Set call forward number used when call is rejected on busy or for auto forward',
    sett_comment_short_callforwardonbusy: '',

    sett_display_name_callforwardonnoanswer: 'Call forward no answer',
    sett_comment_callforwardonnoanswer:
      'Set call forward number calls should be forwarded if no answer',
    sett_comment_short_callforwardonnoanswer: '',

    sett_display_name_callforwardonnoanswertimeout: 'Call forward no answer timeout',
    sett_comment_callforwardonnoanswertimeout:
      'Delay in seconds before call is forwarded on no answer',
    ...
    sett_comment_calltransferalways:
      'Set call transfer number where all calls should be transferred',
    ...
    sett_comment_usetunneling_1:
      'Useful in VoIP blocked countries and from behind firewalls. If you need to use this feature for more than a few calls, then you should upgrade to MizuDroidPro which includes unlimited tunneling service.',
    ...
    sett_comment_rejectonphonebusy:
      'Set behavior if there is already a native phone call in progress',
    sett_comment_short_rejectonphonebusy: '',

    sett_display_name_proximitysensor: 'Proximity sensor',
    sett_comment_proximitysensor:
      'Turn off the screen while in call. This feature is turned off by default because most of the devices has problems when turned on',
    ...
    sett_comment_denoise:
      'Remove noise from the conversation (such as background noise or noise generated by the microphone).',
    sett_comment_short_denoise: '',

    sett_display_name_silencesupress: 'Silence suppression',
    sett_comment_silencesupress:
      'Do not transmit media when you do not speak. Enable only if your if your bandwidth is really poor.',
    sett_comment_short_silencesupress: '',

    sett_display_name_plc: 'PLC',
    sett_comment_plc:
      'Packet loss concealment. Helps to improve the call quality on packet loss which occurs on low quality networks',
    ...
    sett_comment_audiorecorder:
      'Select audio recorder stream for calls. Should be changed only on special devices or if you have special requirements or the automatic setting is not the preferred',
    sett_comment_short_audiorecorder: '',

    sett_display_name_audioplayer: 'Audio player',
    sett_comment_audioplayer:
      'Select audio player stream for calls. Should be changed only on special devices or if you have special requirements or the automatic setting is not the preferred',
    sett_comment_short_audioplayer: '',

    sett_display_name_speakerphoneplayer: 'Speakerphone player',
    sett_comment_speakerphoneplayer:
      'Select audio speakerphone player stream. Should be changed only on special devices or if you have special requirements or the automatic setting is not the preferred',
    ...
    sett_comment_keepalive:
      'Will send a short packet in the specified time interval (seconds) to open and keep your NAT device (router) opened in order to enable incoming calls and other notifications',
    ...
    sett_comment_setqos:
      'Sets traffic class or type-of-service octet in the IP header for UDP packets',
    sett_comment_short_setqos: '',

    sett_display_name_codecframecount: 'RTP Frame/Packet',
    sett_comment_codecframecount:
      'Number of codec payloads in one UDP/RTP packet. Higher values will require less bandwidth but more delays. Unusual values (above 4) can cause incompatibility with your provider.',
    ...
    sett_comment_doublesendrtp:
      'Might improve audio quality in certain circumstances, but will increase upload data amount',
    sett_comment_short_doublesendrtp: 'Double send RTP packets',

    sett_display_name_cfgcpuspeed: 'CPU Speed',
    sett_comment_cfgcpuspeed:
      'Features such as AEC or codec are turned on/off based on your device processor speed',
    ...
    sett_comment_cfgnetworkspeed:
      'Helps to choose the best codec and media enhancements for your calls.',
    sett_comment_short_cfgnetworkspeed: '',

    sett_display_name_accounts: 'Accounts',
    sett_comment_accounts:
      'Manage multiple SIP accounts. Use this only if you wish to set more then one account!',
    sett_comment_short_accounts: '',

    sett_display_name_extraoption: 'Extra options',
    sett_comment_extraoption:
      'Set any custom parameters in a key-value pair list, separated by semicolon.<br />Ex: displayname=John;',
    sett_comment_short_extraoption: 'Set any custom parameters',

    sett_display_name_pushnotifications: 'Enable background calls',
    sett_comment_pushnotifications:
      'Listen for incoming calls also when the webphone is not opened',
    ...
    sett_comment_changesptoring:
      "Treat session progress (183) responses as ringing (180). This might be required if your service provider doesn't send ringing nor early media",
    ...
    sett_comment_customsipheader:
      'Set a custom SIP header (a line in the SIP signaling) that will be sent with all SIP messages (Expert setting)',
    ...
    sett_comment_sendrtponmuted:
      'Send RTP even if muted (zeroed packets). Set to true only if your server is malfunctioning when RTP is suppressed',
    sett_comment_short_sendrtponmuted: '',

    sett_display_name_capabilityrequest: 'Capability request',
    sett_comment_capabilityrequest:
      'If set, then will send a capability request (OPTIONS) message to the SIP server on startup',
    sett_comment_short_capabilityrequest: '',

    sett_display_name_dialerintegration: 'Integrate',
    sett_comment_dialerintegration:
      "When dialing with native dialer you'll be asked if you want to use SIP or mobile",
    ...
    sett_comment_audiobufferlength:
      '-1 means auto. Valid values are between 160 and 16000. Expert setting.',
    ...
    sett_comment_displaynotification:
    ...
    sett_comment_audiodevices:
      'Audio device settings will be available from the dialpad page menu once you login',
    sett_comment_short_audiodevices: '',

    sett_display_name_cpualwayspartiallock: 'CPU always partial lock',
    sett_comment_cpualwayspartiallock:
      "Keep the device processor always awake. Set only if otherwise you loose registrations and don't receive incoming calls",
    ...
    sett_comment_disablewbforpstn:
      'Disable wideband audio codecs for calls to mobile/landline numbers (wideband only for IP to IP calls)',
    sett_comment_short_disablewbforpstn: '',

    sett_display_name_multiplecalls: 'Allow multiple calls',
    sett_comment_multiplecalls:
      'Allow multiple calls / conference (low-end CPU is not capable to handle)',
    sett_comment_short_multiplecalls: '',

    sett_display_name_callbacknumber: 'Callback number',
    sett_comment_callbacknumber:
      'Callback access number. Some VoIP service providers provide this kind of number which you can ring and receive incoming call from server IVR',
    ...
    sett_comment_focusaudio:
      'Focus on VoIP call audio (this might lower the volume for other streams such as your media player while you are speaking on VoIP)',
    sett_comment_short_focusaudio: 'Focus on VoIP audio',

    sett_display_name_useroutingapi: 'Use routing API',
    sett_comment_useroutingapi:
      'Use routing API for compatibility reasons. Some -usually old- devices might need this for correct audio handling',
    sett_comment_short_useroutingapi: '',

    sett_display_name_hardwaremedia: 'Hardware media',
    sett_comment_hardwaremedia:
      'Use hardware media enhancements such as AEC and denoise. This might add a slight delay for the audio streams',
    ...
    sett_comment_natopenpackets:
      'UDP packets to send to open the NAT device (change if you have NAT issues)',
    ...
    sett_comment_transfwithreplace:
      'Specify if replace should be used with transfer so the old call (dialog) is not disconnected but just replaced. This way the A party is never disconnected, just the called party is changed. The A party must be able to handle the replace header for this.',
    sett_comment_short_transfwithreplace:
    ...
    sett_comment_submenu_integrate:
      "When dialing with native dialer you'll be asked if you want to use SIP or mobile",
    ...
    proversion_content_text:
      'Upgrade to the Pro version for commercial usage and extra features such as G.729 codec and others.',
    ...
    no_contacts_2_hu:
      'Vagy használd a “Kontaktok szinkronizálása” menu opciot, hogy importáld be a kontaktokat a mobilodról.<br />(A szinkronizálás csak akkor fog müködni, miután feltöltöd a kontaktokat a mobilodról.)',
    sync_title_hu: 'Kontaktok szinkronizálása',
    sync_message_hu:
      'A szinkronizálás csak akkor fog müködni, miután feltöltöd a kontaktokat a mobilodról.',
    ...
    ie_update_hu:
      'Ez a szoftver egy újabb verziojú Internet Explorert igényel. Szeretné letölteni és frissiteni?',
    install_java_hu: 'Java szükséges: https://java.com/download/',
    serviceengine_title_hu: 'Service plugin használása',
    serviceengine_msg_hu:
      'Install service plugin for a better experience Instaláld a service plugin-t egy jobb müködésért ',
    ...
    ce_enablejava_hu:
      '<a href="https://java.com/en/download/help/enable_browser.xml" target="_blank">Enable java in your browser setting Java engedelyezése</a>',
    ce_install_java_hu:
      'Vagy ha nincs java instalálva, instaláld innen<a href="https://java.com/download/" target="_blank"></a>',
    ...
    np_install_msg_hu:
      'Service plugin letöltése...<br />Plugin instalálása után jelentkezzél be.<br /><br />Nyomjál visszamondást, ha nem akarod használni a Service plugin-t.',
    ...
    chrome_local_alert_hu:
      'A webphone nem fog müködni local filesystem-ről a Google Chrome és Opera böngészőkben. Csak webserverről fog müködni. Ha local filesystem-ről szeretnéd tesztelni, akkor használhatsz Firefox-ot vagy Internet Explorer-t.',
    //OPSSTART
    ...
    connection_msg_hu:
      'Úgy néz ki, hogy nem vagy kapcsolódva a hálozathoz vagy az internethez.<br> Ellenőrizd a kapcsolatod.',
    ...
    warning_msg_1_hu:
      'Csak direkt hivások a SIP URI-khoz lehetségesek, ha a VoIP szerver cime nincs megadva',
    warning_msg_2_hu:
      'IP vagy domain név nincs elfogadva ebben a verzióban. Ird be a szerver nevet vagy ID-t.',
    warning_msg_3_hu: 'Kérlek ird be a kontakt nevet ',
    warning_msg_4_hu:
      'Konfigurációk visszakérése sikertelen. .<br /><br /> A beállitások oldalon a Szerver mezőbe ird be a VoIP szolgáltatód domain nevét vagy IP cimjét',
    ...
    err_flash_local_hu:
      'A Flash engine csak akkor fog müködni, ha webszerverről lesz futtatva, nem lokális file systemről',

    srvaddr_help_hu:
      "VoIP service provider server address (ip address or domain name or DNS SRV record). You can also suffix a port number if the server is not on the default SIP port (5060). Example: yourserver.com:6000<br /><br /> In case if you are new to VoIP:<br /> Unlike some other popular software such as Skype, if you are using standard SIP protocol you can use any VoIP provider. There are a hundreds of such kind of services and you could also setup your own server, for example using Mizu server or Asterisk.<br /> Internal (softphone to softphone) calls are usually free and the cost of outbound calls (calls to mobile or landline) are usually cheaper than for traditional providers, especially international calls.<br /> There are also a lot of other benefits in using standard VoIP such as high call quality (with wideband codec), freedom (you can switch your provider at any time), control (you can easily manage your account) and flexibility (lots of extra services such as call recording, conferencing and others). You can even use multiple providers (for example you can always use the cheaper one for your call targets).<br /> If you don't have a VoIP account yet then you can create one within a few minutes at any provider and start using VoIP right now: https://www.voip-info.org/wiki/view/Sip+Phone+Service+Providers",

    sett_display_name_serveraddress_user_hu: 'Szerver',
    sett_comment_serveraddress_user_hu:
      'Ird be a szerver cimét (domain vagy IP:port), brand név vagy operátor kód',
    ...
    sett_comment_startonboot_hu:
      'Mindig várja a bejövő hivásokat (a service háttérben fog futni, hogy engedélyezze a bejövő hivásokat)',
    ...
    sett_comment_register_hu:
      'Regisztrálás a domainhez. Ez mindig szülséges, hogy fogadhassál bejövő hivásokat és néhány szolgáltató igényli a kimenő hivások engedélyezéséhez is.',
    ...
    sett_comment_proxyaddress_hu:
      'Kimenő proxy szerver cime. Hagyd üresen, ha nincs egy stateless/kimenő proxy szervered',
    ...
    sett_comment_voicemailnum_hu:
      'Allitsd be a hangposta számot, amely használva lesz ha nem kapod meg automatikusan.',
    sett_comment_short_voicemailnum_hu: 'Hangposta szám beállitása',

    sett_display_name_use_stun_hu: 'STUN használata',
    sett_comment_use_stun_hu:
      'Változtasd meg, ha NAT specifikus problémáid vannak (nem tudsz regisztrálni, nem tudsz hivni, audio problémák)',
    ...
    sett_comment_use_fast_ice_hu:
      'Gyors ICE tárgyalások (p2p RTP routolásra).<br>Megjegyzés: ha “Auto”-ra van állitva vagy “Yes”-re, akkor a STUN nincs kikapcsolva ',
    ...
    sett_comment_volumein_hu:
      'Az alapértelmezett mikrofon állítása 0 és 100% között. 50 azt jelenti, hogy nincsenek változtatások',
    sett_comment_short_volumein_hu: '',

    sett_display_name_volumeout_hu: 'Kimenő hangerősség',
    sett_comment_volumeout_hu:
      'Az alapértelmezett kihangositó állítása 0 és 100% között. 50 azt jelenti, hogy nincsenek változtatások.',
    sett_comment_short_volumeout_hu: '',

    sett_display_name_prack_hu: 'PRACK használata',
    sett_comment_prack_hu:
      '100rel támogatva. Csak abban az esetben kell bekapcsolni, ha a szervered igényli ezt',
    ...
    sett_comment_calltimeout_hu:
      'Maximális engedélyezett hivásidőtartam. Alapértéke 10800 másodperc, ami 3 óra.',
    sett_comment_short_calltimeout_hu: '',

    sett_display_name_username_hu: 'Hivó ID',
    sett_comment_username_hu:
      'Ez nem az autentikálásra lesz használva. Add meg, ha nem ugyanaz mint a Felhasználónév. Egyes VoIP szerverek visszafogják utasitani ha nem ugyanaz mint a Felhasználónév!',
    sett_comment_short_username_hu:
      'Beállithatsz egy különböző felhasználónevet, ami A számként fog szerepelni',

    sett_display_name_displayname_hu: 'Megjelenített név',
    sett_comment_displayname_hu:
      'Megjelenített név meghatározása.Ez egy opcionális beállítás és lehet a teljes neved',
    ...
    sett_comment_signalingport_hu:
      'Lokális signaling port meghatározása (alapból egy stabil port, ami egy találomszerű értékkel van inicializálva. Ennek a portnak semmi köze sincs a szerver SIP portjához, ami általában 5060)',
    ...
    sett_comment_rtpport_hu:
      'Lokális RTP port-intervallum meghatározása (alapból egy stabil port-intervallum, ami találomszerű értékekkel van inicializálva)',
    sett_comment_short_rtpport_hu: 'Lokális RTP port-intervallum meghatározása',

    sett_display_name_jittersize_hu: 'Jitter mérete',
    sett_comment_jittersize_hu:
      'A jitter buffer sima lejátszáshoz használatos változó sávszélességalatt. A mérete dinamikusan van kiszámitva, de ennek a viselkedése megváltozható ezzel a beállitással',
    sett_comment_short_jittersize_hu: '',

    sett_display_name_forcewifi_hu: 'Wifi erőltetése',
    sett_comment_forcewifi_hu:
      'Engedélyezd és szkenneld a wifi-t induláskor, új hiváskor vagy kapcsolat elvesztésekor (Ez a beállítás nélkül is a WiFi lesz elönyben ha rendelkezésre áll)',
    ...
    sett_comment_callforwardonbusy_hu:
      'Állitsál be egy hivásátirányitási számot, azokra a hivásokra amelyek elutasitva vannak foglalt esetén vagy automatikus irányitásra',
    ...
    sett_comment_rejectonvoipbusy_hu:
      'Állitsd be hogyan viselkedjen, ha már egy VoIP hivás folyamatban van',
    sett_comment_short_rejectonvoipbusy_hu: '',

    //OPSSTART
    sett_display_name_usetunneling_hu: 'Tunneling éstitkosítás',
    sett_comment_usetunneling_hu:
      'Használjon titkositott és tunneles transport layer-eket (UDP, TCP vagy HTTP)',
    sett_comment_short_usetunneling_hu: 'Használjon alternativ titkositást',
    sett_comment_usetunneling_1_hu:
      'Hasznos azokban az országokban, ahol a VoIP blokkolva van és tüzfalak mögül. Ha gyakran szeretnéd használni ezt a funkciót, akkor kellene upgradeoljál MizuDroidPro-ra, amiben korlátlan titkositás engedélyezett',
    ...
    sett_comment_androidvoicerecording_hu:
      'Ha be van kapcsolva, az összes hivás rögzitve lesz és elérhetőek lesznek a hiváslistából.',
...
*/
    ...
    sett_comment_loglevel_hu:
      'Logok mentése fájl-ba, hogy a későbbiekben feltölthetőek legyenek az ügyfélszolgálathoz',
    sett_comment_short_loglevel_hu: '',

    sett_display_name_rejectonphonebusy_hu: 'Foglalt esetén',
    sett_comment_rejectonphonebusy_hu:
      'Állitsd be a viselkedését, ha már van egy nativ telefonhivás folyamatban',
    sett_comment_short_rejectonphonebusy_hu: '',

    sett_display_name_proximitysensor_hu: 'Közelségérzékelő',
    sett_comment_proximitysensor_hu:
      'Kapcsolja ki a képernyőt hivás közben. Ez a funkció ki van kapcsolva alapból, mert legtöbb készüléken probléma van a visszakapcsolással',
    sett_comment_short_proximitysensor_hu:
      'Kapcsolja ki a képernyőt amig a készülék közel van a fülhöz',

    sett_display_name_aec_hu: 'AEC',
    sett_comment_aec_hu:
      'Akusztikus visszhangelnyomás. Kapcsold ki, ha visszhangot tapasztalnak a hivó felek. ',
    sett_comment_short_aec_hu: '',

    sett_display_name_agc_hu: 'AGC',
    sett_comment_agc_hu:
      'Automatikus erősítésszabályozás. A hangerősséget fogja szabályozni automatikusan',
    sett_comment_short_agc_hu: '',

    sett_display_name_denoise_hu: 'Zajszürő',
    sett_comment_denoise_hu:
      'Kiszüri a zajt a beszélgetesekből (háttérzaj vagy a mikrofon által generált zaj)',
    sett_comment_short_denoise_hu: '',

    sett_display_name_silencesupress_hu: 'Csend elnyomás',
    sett_comment_silencesupress_hu:
      'Ne küldje a médiát, amikor nincs beszélgetés. Csak akkor kapcsold be, ha a sávszélességed nagyon kicsi.',
    sett_comment_short_silencesupress_hu: '',

    sett_display_name_plc_hu: 'PLC',
    sett_comment_plc_hu:
      'Csomagvesztés eltitkolása. Segít a hivásminőség növelésén gyenge minőségő hállózatok esetén',
    ...
    sett_comment_audiorecorder_hu:
      'Csak speciális eszközöknél kell megváltoztatni, vagy különleges követelmények esetén, vagy haaz automatikus beállítás nem preferált',
    sett_comment_short_audiorecorder_hu: '',

    sett_display_name_audioplayer_hu: 'Audió lejátszó',
    sett_comment_audioplayer_hu:
      'Válaszd ki az audio lejátszót. Csak speciális eszközöknél kell megváltoztatni, vagy különleges követelmények esetén, vagy haaz automatikus beállítás nem preferált',
    sett_comment_short_audioplayer_hu: '',

    sett_display_name_speakerphoneplayer_hu: 'Kihangositó lejátszó',
    sett_comment_speakerphoneplayer_hu:
      'Válaszd ki a kihangositó lejátszóját. Csak speciális eszközöknél kell megváltoztatni, vagy különleges követelmények esetén, vagy haaz automatikus beállítás nem preferált',
    ...
    sett_comment_keepalive_hu:
      'Fog küldeni egy rövid csomagot a megadott időintervallumokban (másodpercek), hogy megnyitsa és nyitva tartsa a NAT készüléked (router), hogy lehetővé tegye a bejövő hivásokat és más értesitéseket',
    ...
    sett_comment_setqos_hu:
      'Állitsd be a forgalom osztályát vagy a szolgáltatás tipusát oktettben az IP fejlécben az UDP csomagoknak',
    sett_comment_short_setqos_hu: '',

    sett_display_name_codecframecount_hu: 'RTP Keret/Csomag',
    sett_comment_codecframecount_hu:
      'Kodek rakomány száma egy UDP/RTP csomagban. A magasabb értékek kisebb sávszélességet igényelnek, de több a késés.A nem szokásos értékek (4 fölött) inkompatibilitási problémákat okozhatnak a szolgáltatóval.',
    ...
    sett_comment_doublesendrtp_hu:
      'Javithatja a hangminőséget bizonyos körülmények között, de növeli a feltöltési adatok mennyiségét',
    sett_comment_short_doublesendrtp_hu: 'RTP csomagok kétszeres elküldése',

    sett_display_name_cfgcpuspeed_hu: 'CPU sebessége',
    sett_comment_cfgcpuspeed_hu:
      'Funkciókat, mint például az AEC vagy kodekek be-ki kapcsolását határozza meg az eszköz proceszorának a sebessége',
    sett_comment_short_cfgcpuspeed_hu:
      'A funkciók automatikusan vannak kiválasztva a processzor sebességétől függően',
    ...
    sett_comment_extraoption_hu:
      'A sajátos paraméterek beállithatok kulcs-érték párositásokban, pontosvesszővel elválasztva. <br> Példa: Megjelenítendőnév=János;',
    ...
    sett_comment_changesptoring_hu:
      'A session progress(183) kezelése mint ringing (180). Ez akkor szükséges, ha a szolgáltatod nem küld ringing-et vagy early media-t',
    ...
    sett_comment_defmute_hu:
      'Határozd meg, hogy némitsa a hivást, amikor a  némitás gomb megvan nyomva',
    sett_comment_short_defmute_hu: '',

    sett_display_name_automute_hu: 'Némitás új hivások esetén',
    sett_comment_automute_hu:
      'Határozd meg, ha a folyamatban levő hivásokat kell-e némitani új hivás esetén',
    sett_comment_short_automute_hu: '',

    sett_display_name_autohold_hu: 'Hivás tartása új hivás esetén',
    sett_comment_autohold_hu:
      'Határozd meg, hogy a folyamatban levő hivásokat tartásba kell-e tenni',
    sett_comment_short_autohold_hu: '',

    sett_display_name_customsipheader_hu: 'Sajátos SIP fejléc',
    sett_comment_customsipheader_hu:
      'Sajátos sip fejléc (egy sor a SIP signaling-ba), ami el lesz küldve az összes SIP üzenetben (Szakértői beállitás)',
    ...
    sett_comment_sendrtponmuted_hu:
      'Küldje a médiát némitás esetén is. Csak akkor állitsd true-ra, ha a szervered nem tudja lekezelni az RTP elnyomottságot',
    sett_comment_short_sendrtponmuted_hu: '',

    sett_display_name_capabilityrequest_hu: 'Képesség lekérése',
    sett_comment_capabilityrequest_hu:
      'Ha bevan állitva, akkor fog küldeni egy képesség lekérési üzenetet (OPTIONS) a SIP szervernek induláskor',
    sett_comment_short_capabilityrequest_hu: '',

    sett_display_name_dialerintegration_hu: 'Integrálás',
    sett_comment_dialerintegration_hu:
      'A natív tárcsázó használatakor meg leszel kérdezve, hogy SIP-et akarsz használni vagy mobilt',
    ...
    sett_comment_audiobufferlength_hu:
      '-1 automatikusat jelent. Valós értékek 160 és 1600 között vannak. Szakértő beállitás.',
    sett_comment_short_audiobufferlength_hu:
      'Szakértő beállitás az audió lejátszóbuffer méretének a meghatározására',
    ...
    sett_comment_displaynotification_hu:
      'Értesitések megjelenitése a telefon értesitési sávján (általában a telefon felső sarkában)',
    sett_comment_short_displaynotification_hu:
      'Értesitések megjelenitése a telefon értesitési sávján',
    ...
    sett_comment_cpualwayspartiallock_hu:
      'Állandóan ébren tartja a készülék processzorát. Csak abban az esetben állitsd be, ha másképpen a softphone elvesziti a regisztrálást és nem müködnek a bejövő hivások',
    ...
    sett_comment_disablewbforpstn_hu:
      'Szélessávú audio kodekek letiltása kimenő (mobil/vezetékes telefon) hivásokra (szélessávú kodekek csak lokális hivásokra)',
    sett_comment_short_disablewbforpstn_hu: '',

    sett_display_name_multiplecalls_hu: 'Többszörös hivás engedélyezése',
    sett_comment_multiplecalls_hu:
      'Többszörös hivás/konferencia engedélyezése(gyenge CPU-k nem tudják lekezelni)',
    sett_comment_short_multiplecalls_hu: '',

    sett_display_name_callback_accessnumber_hu: 'Callback szám',
    sett_comment_callback_accessnumber_hu:
      'Callback access szám. Néhány VoIP szolgáltató biztosít ilyen számokat, amelyeket hivhatod és kapsz egy bejövő hivást a szerver IVR-től',
    ...
    sett_comment_focusaudio_hu:
      'Fokuszálás a VoIP hivásokra (ez lehalkithatja a többi médialejátszót VoIP hivások alatt)',
    sett_comment_short_focusaudio_hu: 'Fokuszálás VoIP audióra',

    sett_display_name_useroutingapi_hu: 'Routolási API használata',
    sett_comment_useroutingapi_hu:
      'Néhány régebbi készüléknek szüksége van erre a helyes audio kezeléshez',
    sett_comment_short_useroutingapi_hu: '',

    sett_display_name_hardwaremedia_hu: 'Hardware média',
    sett_comment_hardwaremedia_hu:
      'Használjon hardware média fejlesztéseket, mint AEC és zajtalanitás. Megtörténhet, hogy egy kis késleltetést okoz',
    ...
    sett_comment_nativefilterallow_hu:
      'Kezelje a natív hivásokat, ha a szám a következő prefixel kezdődik',
    sett_comment_short_nativefilterallow_hu: '',

    sett_display_name_nativefilterblock_hu: 'Nem engedélyezett prefixek',
    sett_comment_nativefilterblock_hu:
      'Ne kezelje a natív hivásokat, ha a szám a következő prefixel kezdődik',
    sett_comment_short_nativefilterblock_hu: '',

    sett_display_name_integrateifwifionly_hu: 'Integrálás csak Wifi esetén',
    sett_comment_integrateifwifionly_hu:
      'Integrálás a natív tárcsázóval csak Wifi kapcsolat esetén',
    ...
    sett_comment_natopenpackets_hu:
      'NAT készülékek  nyitva tartása UDP csomagok küldésével (változtasd meg, ha NAT problémáid vannak)',
    ...
    sett_comment_submenu_integrate_hu:
      'A natív tárcsázó használatakor meg leszel kérdezve, hogy SIP-et akarsz használni vagy mobilt',
    ...
    proversion_content_text_hu:
      'Upgrade to Softphone Pro<br /><br />' +
    ...
    dlg_about_msg_hu:
      '[BRANDNAME] Version [APPVERSION]<br /><br />' +
    ...
    sett_comment_callforwardalways_hu:
      'Állitsd be azt a telefonszámot, ahová szeretnéd a hivásokat átirányitani',
    sett_comment_short_callforwardalways_hu: '',

    sett_display_name_calltransferalways_hu: 'Hivástranszferálás',
    sett_comment_calltransferalways_hu:
      'Állitsd be azt a telefonszámot, ahová szeretnéd a hivásokat transzferálni',
    ...
    sett_comment_audiodevices_hu:
      'Az audió eszköz beállitásai elérhetok lesznek a hivó oldalról amikor bejelentkezel',
    sett_comment_short_audiodevices_hu: '',

    sett_display_name_callbacknumber_hu: 'Callback szám',
    sett_comment_callbacknumber_hu:
      'Callback szám. Egyes VoIP szolgáltatók juttatnak egy számot amit fel lehet hívni es visszahív egy szerver IVR',
    ...
    sett_comment_transfwithreplace_hu:
      'Határozd meg, ha hiváscserét kell használni transzfer esetén, igy a folyamatban levo hivás nincs lezárva, csak le van cserélve. Ebben az esetben az A fél soha sincs lezárva, csak a hivó fél változik meg. A hivó fél kell tudja lekezelni a Replace header-t ennek a funkciónak a müködésének az érdekében',
    sett_comment_short_transfwithreplace_hu:
      'Határozd meg, hogy a transzfer cserével kell-e véghez vivodjön.',
    ...
    warning_feature_hu:
      'Szükséged van egy Pro licenszre ennek a funkciónak az aktiválásához.<br />A licensz aktiválásához elöször jelentkezzél be, majd válaszd a "Licensz"-t a menü-bol.',
    allowmedia_title_hu: 'Média hozzáférés',
    allowmedia_chrome_hu:
      'szüksége van a mikrofon hozzáféréséhez.<br />A hozzáférés engedélyezéséhez, klikkeljél a "hang" ikonra a böngészod jobb felso sarkában és válaszd az "engedélyez" opciót, majd indits egy uj hivást.',
    allowmedia_firefox_hu:
      'szüksége van a mikrofon hozzáféréséhez.<br />A hozzáférés engedélyezéséhez, klikkeljél a "mikrofon" ikonra a böngészod közép-felso részében és válaszd az "engedélyez" opciót, majd indits egy uj hivást.',
    allowmedia_general_hu:
      'szüksége van a mikrofon hozzáféréséhez.<br />A hozzáférés megkapása után indits egy uj hivást.',
    ...
    chrome_local_webrtc_audio_hu:
      'A WebRTCnek nincs jogosultsága, hogy hozzáférjen az audio eszközökhez egy lokális fájlrendszerrol a Chrome és Opera böngészokben. \nA webphone egy biztonságos webszerveren kell legyen hosztolva (HTTPS), hogy müködjenek a bejövo és kimeno hivások WebRTC-n',
    ...
    chrome_https_hu:
      'A webphone-nak a helyes müködésének érdekében ajánljuk, hogy hosztolják ezt egy biztonságos webszerveren (https), másképpen a hivások nem fognak müködni WebRTCn.',
    ...
    chrome_https_reload_hu:
      'Chrome-ban és Opera-ban a WebRTC csak https-en fog müködni. \n\n Klikkeljál az OK-ra, hogy ujratöltse az oldalt használva a Mizu https proxy-t',
    all_demo_msg_hu:
      '(ezek az üzenetek csak a demo verzióban jelennek meg, a full verzióban ezek az esetek levannak kezelve automatikusan)',
    ...
    filter_warning_hu:
      'Legalább az "Amikor a szám ezzel kezdodik" vagy "Cseréld ki erre" mezok ki kell legyenek töltve.',
    ...
    java_freeze_ff_hu:
      'Miután elfogadtad az "Alkalmazás futtatása"-t,\n klikkeljél az OK-ra a folytatáshoz',
    ...
    hint_more_hu: 'Több',
    ce_ask_user_hu:
      'Ugy néz ki, hogy a [SELECTEDENGINE] engine nem müködik. Probáljuk ki a [RECOMMENDED] engine-t?',
    ...
    username_err_hu:
      'A felhasználónév tartalmaz nem támogatott speciális karaktereket, kérlek ird át',
    ...
    webcallme_msg_hu:
      'Küld el ezt a linket a barátaidnak és ok feltudnak majd hivni egy egyszeru klikkel',
    ...
    service_update_hu:
      'Egy új verzió NS-Service Plugin jelent meg. Ajánljuk, hogy frissitsél az utolsó verzióra.',
    ...
    no_contacts_2_pt:
      'Ou use a opção do menu "Sincronizar Contatos" para importar contatos do seu celular. <br /> (só funcionará depois que você carregar contatos do seu celular)',
    sync_title_pt: 'Sincronizar contatos',
    sync_message_pt:
      'Sincronizar irá funcionar apenas depois de ter carregado contatos do seu celular',
    ...
    ie_update_pt:
      'Esta aplicação requer uma versão mais recente do Internet Explorer. Gostaria de baixar e atualizar?',
    ...
    np_popup_msg_pt:
      'É necessário instalar o plug-in de serviço para que o softphone possa funcionar',
    ...
    ce_enablejava_pt:
      '<a href="https://java.com/en/download/help/enable_browser.xml" target="_blank"> ativar o Java em seu navegador definindo </a>',
    ce_install_java_pt:
      'Ou se você não tem java instalado, instale clicando <a href="https://java.com/download/" target="_blank">aqui.</a>',
    ...
    np_install_msg_pt:
      'Faça o download do plug-in serviço e instale. <br /> Clique em OK depois de pronto ou Cancelar para abortar',
    np_successfully_installed_pt: 'Plugin de serviço instalado com sucesso',
    java_install_title_pt: 'Baixe e instale Java',
    java_install_pt:
      'Clique em OK para iniciar o download Java. <br> Entrar novamente depois de ter terminado a instalar',
    ...
    connection_msg_pt:
      'Parece que você não está conectado a uma rede ou à Internet <br> Por favor, verifique sua conexão',
    ...
    warning_feature_pt:
      'Você precisa obter uma licença Pro para ativar esse recurso. <br /> Para ativar licença, faça o login e em seguida, selecione "Licença" no menu',
    allowmedia_title_pt: 'Acesso à mídia',
    allowmedia_chrome_pt:
      'precisa de acesso ao seu microfone. <br /> Para conceder acesso, clique no ícone "som" no canto superior direito do navegador e selecione "permitir", em seguida, refazer a chamada',
    allowmedia_firefox_pt:
      'precisa de acesso ao seu microfone. <br /> Para conceder acesso, clique no ícone "microfone" no centro-top navegador e selecione "permitir", em seguida, refazer a chamada',
    allowmedia_general_pt:
      'precisa de acesso ao seu microfone. <br /> Depois de concedido o acesso, refazer a chamada',
    ...
    chrome_local_alert_pt:
      'O Webphone não trabalha em sistema de arquivos local no Google Chrome ou navegadores Opera.\n Você deve implantá-lo em um servidor web.\n\n Você pode usar o Firefox ou IE, se você quiser experimentá-lo a partir de sistema de arquivos local',
    chrome_local_webrtc_audio_pt:
      'O WebRTC não tem permissão para acessar dispositivos de áudio a partir do sistema de arquivos local em navegadores Chrome e Opera.\n O webphone deve ser hospedado em um servidor web seguro (HTTPS) para ser capaz de fazer / receber chamadas usando WebRTC',
    ...
    chrome_https_pt:
      'Para Chrome e Opera recomendamos para hospedar o webphone em http segura (https), caso contrário WebRTC não vai funcionar',
    ...
    chrome_https_reload_pt:
      'Para Chrome e Opera o WebRTC só vai trabalhar a partir de http seguro (https).\n\n Clique em OK para recarregar a página usando foneflex https proxy',
    all_demo_msg_pt:
      '(Estas mensagens são exibidas apenas na versão demo, na versão final estas situações são manipuladas automaticamente)',
    ...
    java_freeze_ff_pt:
      'Depois de aceitar para "executar esta aplicação",\n Clique em OK para continuar',
    ...
    hint_more_pt: 'Mais',
    ce_ask_user_pt:
      'Parece que [SELECTEDENGINE] motor não está funcionando. Devemos tentar [RECOMMENDED] motor?',
    ...
    webcallme_msg_pt:
      'Enviar este link para seus amigos e eles serão capazes de chamá-lo com um simples clique',
    ...
    service_update_pt:
      'Uma nova versão do NS -Serviço Plugin está disponível. É altamente recomendável atualizar para a versão mais recente',
    ...
    logview_msg_pt:
      'A página pode não estar disponível para alguns segundos. Recarregar a página se não acontecer nada',
    messagepl_pt: 'Compor',
    ...
    warning_msg_1_pt:
      'Somente chamadas diretas para URIs serão possíveis se o endereço VoIP Server não estiver definido',
    warning_msg_2_pt:
      'IP ou nome de domínio não é aceito nesta versão. Inserir o nome do servidor ou ID aqui',
    warning_msg_3_pt: 'Por favor, indique o nome do contato',
    warning_msg_4_pt:
      'Falha em recuperar configurações.<br /><br />Na entrada página Configurações do Servidor, insira seu nome de domínio VoIP ou o endereço IP',
    ...
    use_fast_ice__no_pt:
      'Não (definido como 0 somente se o servidor precisar sempre via os meios de comunicação)',
    ...
    sett_comment_startonboot_pt:
      'Sempre ouvir para receber chamadas (serviço será executado no backround para permitir chamadas recebidas)',
    ...
    sett_comment_register_pt:
      'Registre-se para domínio. Este é sempre necessária para receber chamadas e alguns provedores exigem também para permitir chamadas de saída',
    ...
    sett_comment_filters_pt:
      'Adicionar regras de reescrita número do destino (adicionar / remover / reescrever prefixo)',
    sett_comment_short_filters_pt: '',

    sett_display_name_earlymedia_pt: 'Enviar media início',
    sett_comment_earlymedia_pt:
      'Iniciar para enviar a mídia quando o progresso da sessão é recebido',
    ...
    sett_comment_proxyaddress_pt:
      'Endereço de proxy SIP de saída. Deixe em branco se você não tem um proxy / outbound',
    sett_comment_short_proxyaddress_pt: 'Endereço de proxy de saída',

    sett_display_name_realm_pt: 'Domínio',
    sett_comment_realm_pt:
      'Definir o domínio SIP se não for o mesmo com o server address ou domínio',
    sett_comment_short_realm_pt: '',

    sett_display_name_voicemailnum_pt: 'Voicemail',
    sett_comment_voicemailnum_pt:
      'Definir o número de correio de voz que será usado se não for recebido automaticamente',
    sett_comment_short_voicemailnum_pt: 'Definir número de acesso do correio de voz',

    sett_display_name_use_stun_pt: 'Use STUN',
    sett_comment_use_stun_pt:
      'Mudar se você tem problemas relacionados NAT (registo, chamada, não há problemas de voz)',
    sett_comment_short_use_stun_pt: 'Habilitar a descoberta endereço externo',

    sett_display_name_use_fast_ice_pt: 'Use ICE',
    sett_comment_use_fast_ice_pt:
      'Negociações rápido no ICE (para roteamento p2p RTP) <br />. Nota: Se definido para "Auto" ou "Sim", então STUN não deve ser desativado',
    ...
    sett_comment_volumein_pt:
      'Definir o volume do microfone padrão entre 0 e 100%. 50% significa que não há mudanças de volume',
    sett_comment_short_volumein_pt: '',

    sett_display_name_volumeout_pt: 'Volume out',
    sett_comment_volumeout_pt:
      'Definir o volume do alto-falante padrão entre 0 e 100%. 50% significa que não há mudanças de volume',
    ...
    sett_comment_ringtimeout_pt:
      'O tempo máximo permitido a tocar em segundos. O padrão é 90 segundos',
    sett_comment_short_ringtimeout_pt: '',

    sett_display_name_calltimeout_pt: 'Tempo de espera de chamada',
    sett_comment_calltimeout_pt:
      'O tempo máximo permitido discurso em segundos. O padrão é 10800 segundos, o que significa 3 horas',
    sett_comment_short_calltimeout_pt: '',

    sett_display_name_username_pt: 'Caller ID',
    sett_comment_username_pt:
      'Isto não irá ser utilizado para a autenticação. Especificar se não for o mesmo com o usuário para configuração de autenticação. Alguns servidores VoIP irão rejeitar se não for o mesmo com o nome de usuário!',
    sett_comment_short_username_pt:
      'Você pode definir um nome de usuário diferente aqui usado para uma exibição de número',

    sett_display_name_displayname_pt: 'Mostrar nome',
    sett_comment_displayname_pt:
      'Especificar nome de exibição. Esta é uma configuração opcional e deve ser o seu nome completo',
    ...
    sett_comment_localip_pt:
      'Opcionalmente especificar o endereço IP de sinalização local para usar',
    sett_comment_short_localip_pt: '',

    sett_display_name_signalingport_pt: 'Porta de sinalização local',
    sett_comment_signalingport_pt:
      'Especifique o endereço IP local porta de sinalização de usar (o padrão é uma porta estável inicializado com um valor aleatório. Isso não tem nada a ver com a porta SIP servidor que é geralmente 5060)',
    sett_comment_short_signalingport_pt:
      'Opcionalmente especificar a porta de sinalização local para usar',

    sett_display_name_rtpport_pt: 'Porta RTP local',
    sett_comment_rtpport_pt:
      'Especificar base local porto RTP (o padrão é uma base porta estável inicializado com um valor aleatório)',
    sett_comment_short_rtpport_pt: 'Especificar base local porto RTP',

    sett_display_name_jittersize_pt: 'O tamanho do jitter',
    sett_comment_jittersize_pt:
      'O buffer de jitter é usado para reprodução suave sob largura de banda variável. O tamanho é calculado de forma dinâmica, mas o seu comportamento pode modificado com esta definição',
    sett_comment_short_jittersize_pt: '',

    sett_display_name_forcewifi_pt: 'Forçar WiFi',
    sett_comment_forcewifi_pt:
      '(Re) Habilitar e digitalizar WiFi no arranque, nova chamada ou perda de conexão (Mesmo sem esta definição, Wi-Fi será a preferida quando disponível)',
    ...
    sett_comment_callforwardonbusy_pt:
      'Definir número de encaminhamento de chamada usado quando a chamada é rejeitada quando estiver ocupado ou para auto frente',
    sett_comment_short_callforwardonbusy_pt: '',

    sett_display_name_callforwardalways_pt: 'Ligue para a frente sempre',
    sett_comment_callforwardalways_pt:
      'Defina Número de Chamada para a frente, onde todas as chamadas devem ser encaminhadas',
    sett_comment_short_callforwardalways_pt: '',

    sett_display_name_calltransferalways_pt: 'Transferência de chamadas',
    sett_comment_calltransferalways_pt:
      'Definir número de transferência de chamadas, onde todas as chamadas devem ser transferidas',
    ...
    sett_comment_autoaccept_pt:
      'Aceitar automaticamente todas as chamadas recebidas (atendimento automático)',
    ...
    sett_comment_rejectonvoipbusy_pt:
      'Definir o comportamento se já houver uma chamada VoIP em andamento',
    sett_comment_short_rejectonvoipbusy_pt: '',

    //OPSSTART
    sett_display_name_usetunneling_pt: 'Tunneling e criptografia',
    sett_comment_usetunneling_pt:
      'Use camada de transporte criptografado e encapsulado (UDP, TCP ou HTTP)',
    sett_comment_short_usetunneling_pt: 'Utilize os transportes criptografados alternativa',
    sett_comment_usetunneling_1_pt:
      'Útil em VoIP bloqueada países e por trás de firewalls. Se você precisa usar esse recurso para mais do que algumas chamadas, então você deve atualizar para Pro que inclui o serviço de tunelamento ilimitado',
    sett_comment_usetunneling_2_pt:
      'Use a sinalização e meios de comunicação dentro de túnel criptografado',
    //OPSEND
...
*/
    ...
    sett_comment_loglevel_pt:
      'Salve rastreamento para o arquivo para upload mais tarde para suporte técnico',
    sett_comment_short_loglevel_pt: '',
    ...
    sett_comment_rejectonphonebusy_pt:
      'Definir o comportamento se já existe um telefonema nativa em andamento',
    sett_comment_short_rejectonphonebusy_pt: '',

    sett_display_name_proximitysensor_pt: 'Sensor de proximidade',
    sett_comment_proximitysensor_pt:
      'Desligar a tela enquanto na chamada. Este recurso é desativado por padrão porque a maioria dos dispositivos tem problemas quando é ligado',
    ...
    sett_comment_denoise_pt:
      'Remova o ruído da conversa (como o ruído de fundo ou ruído gerado pelo microfone)',
    sett_comment_short_denoise_pt: '',

    sett_display_name_silencesupress_pt: 'Supressão de silêncio',
    sett_comment_silencesupress_pt:
      'Não transmita mídia quando você não fala. Ativar apenas se o seu se a sua largura de banda é realmente pobre',
    sett_comment_short_silencesupress_pt: '',

    sett_display_name_plc_pt: 'PLC',
    sett_comment_plc_pt:
      'Ocultação de perda de pacotes. Ajuda a melhorar a qualidade das chamadas em perda de pacotes que ocorre em redes de baixa qualidade',
    ...
    sett_comment_savetocontacts_pt:
      'Se a (automaticamente) adicionar novos números chamados desconhecidos à lista de contatos',
    ...
    sett_comment_unlockphone_pt:
      'Desbloquear automaticamente a proteção de teclado de telefone em chamada',
    sett_comment_short_unlockphone_pt: '',

    sett_display_name_audiorecorder_pt: 'Gravador de áudio',
    sett_comment_audiorecorder_pt:
      'Selecione fluxo de gravador de áudio para chamadas. Deve ser alterada apenas em dispositivos especiais ou se tiver requisitos especiais ou a configuração automática não é o preferido',
    sett_comment_short_audiorecorder_pt: '',

    sett_display_name_audioplayer_pt: 'Leitor de áudio',
    sett_comment_audioplayer_pt:
      'Selecione fluxo de leitor de áudio para chamadas. Deve ser alterada apenas em dispositivos especiais ou se tiver requisitos especiais ou a configuração automática não é o preferido',
    sett_comment_short_audioplayer_pt: '',

    sett_display_name_speakerphoneplayer_pt: 'Speakerphone',
    sett_comment_speakerphoneplayer_pt:
      'Selecione Stream Player alto-falante de áudio. Deve ser alterada apenas em dispositivos especiais ou se tiver requisitos especiais ou a configuração automática não é o preferido',
    sett_comment_short_speakerphoneplayer_pt: '',

    sett_display_name_speakerphoneoutput_pt: 'Modo de áudio',
    sett_comment_speakerphoneoutput_pt:
      'Selecione o dispositivo de saída quando você alternar para viva-voz',
    sett_comment_short_speakerphoneoutput_pt: '',

    sett_display_name_keepalive_pt: 'Mantenha vivo',
    sett_comment_keepalive_pt:
      'Vou enviar um curto pacote no intervalo de tempo especificado (em segundos) para abrir e manter o seu dispositivo NAT (router) abriu, a fim de permitir que as chamadas recebidas e outras notificações',
    sett_comment_short_keepalive_pt: 'Mantenha o seu NAT aberto',

    sett_display_name_incomingcallalert_pt: 'Ringer',
    sett_comment_incomingcallalert_pt:
      'Selecione fluxo de leitor de áudio para o ring. Deve ser alterada apenas em dispositivos especiais ou se tiver requisitos especiais ou a configuração automática não é o preferido',
    ...
    sett_comment_setqos_pt:
      'Classe de tráfego conjuntos ou octeto tipo de serviço no cabeçalho IP para pacotes UDP',
    sett_comment_short_setqos_pt: '',

    sett_display_name_codecframecount_pt: 'RTP Frame / Packet',
    sett_comment_codecframecount_pt:
      'Número de payloads codec em um pacote UDP / RTP. Valores mais altos exigem menos largura de banda, mas mais atrasos. valores incomuns (acima de 4) pode causar incompatibilidade com seu provedor',
    ...
    sett_comment_doublesendrtp_pt:
      'Pode melhorar a qualidade de áudio em determinadas circunstâncias, mas vai aumentar a quantidade de dados de upload',
    sett_comment_short_doublesendrtp_pt: 'pacotes RTP dupla de envio',

    sett_display_name_cfgcpuspeed_pt: 'Velocidade da CPU',
    sett_comment_cfgcpuspeed_pt:
      'Características como a AEC ou codec está ligado / desligado com base em sua velocidade do processador do dispositivo',
    sett_comment_short_cfgcpuspeed_pt:
      'Os recursos são automaticamente selecionados com base em sua velocidade de CPU',

    sett_display_name_cfgnetworkspeed_pt: 'Velocidade da rede',
    sett_comment_cfgnetworkspeed_pt:
      'Ajuda a escolher o melhor codec e melhorias de mídia para as suas chamadas',
    ...
    sett_comment_extraoption_pt:
      'Definir quaisquer parâmetros personalizados em uma lista de pares de valores-chave, separadas por ponto e vírgula <br /> Ex:. Displayname = João;',
    ...
    sett_comment_changesptoring_pt:
      'Progresso de sessão (183) como respostas de toque (180). Isso pode ser necessário se o seu provedor de serviços indiferente enviar tocar nem primeiros meios',
    sett_comment_short_changesptoring_pt:
      'Tratar o progresso da sessão (183) respostas como toque (180)',
    ...
    sett_comment_defmute_pt:
      'Especificar a forma de silenciar as chamadas quando o botão mute é pressionado',
    sett_comment_short_defmute_pt: '',

    sett_display_name_automute_pt: 'Mute em nova chamada',
    sett_comment_automute_pt:
      'Especificar se as chamadas existentes devem ser silenciado em uma nova chamada',
    sett_comment_short_automute_pt: '',

    sett_display_name_autohold_pt: 'Hold nova chamada',
    sett_comment_autohold_pt:
      'Especificar se as chamadas existentes deve ser susensas em uma nova chamada',
    sett_comment_short_autohold_pt: '',

    sett_display_name_customsipheader_pt: 'Custom SIP cabeçalho',
    sett_comment_customsipheader_pt:
      'Definir um cabeçalho SIP personalizado (uma linha na sinalização SIP) que serão enviadas com todas as mensagens SIP (configuração de especialista)',
    ...
    sett_comment_sendrtponmuted_pt:
      'Enviar RTP ainda que silenciado (pacotes zerados). Definido como verdadeiro somente se o servidor está funcionando corretamente quando RTP é suprimida',
    sett_comment_short_sendrtponmuted_pt: '',

    sett_display_name_capabilityrequest_pt: 'Pedido de capacidade',
    sett_comment_capabilityrequest_pt:
      'Se definido, em seguida enviará uma mensagem de pedido de capacidade (Opções) para o servidor SIP no arranque',
    sett_comment_short_capabilityrequest_pt: '',

    sett_display_name_dialerintegration_pt: 'Integrar',
    sett_comment_dialerintegration_pt:
      'Ao discar com discador nativo você será perguntado se quer usar SIP ou móveis',
    ...
    sett_comment_audiobufferlength_pt:
      '-1 Significa auto. Os valores válidos são entre 160 e 16000. configuração de especialistas',
    sett_comment_short_audiobufferlength_pt:
      'configuração avançada para o tamanho do buffer de reprodução de áudio',
    ...
    sett_comment_displaynotification_pt:
      'Mostrar notificações na barra de notificação do telefone (geralmente no canto superior do seu telefone)',
    sett_comment_short_displaynotification_pt:
      'Mostrar notificações na barra de notificação de telefone',
    ...
    sett_comment_audiodevices_pt:
      'Configurações do dispositivo de áudio estará disponível a partir do menu da página de chamada uma vez que você login',
    sett_comment_short_audiodevices_pt: '',

    sett_display_name_cpualwayspartiallock_pt: 'CPU bloqueio sempre parcial',
    sett_comment_cpualwayspartiallock_pt:
      'Mantenha o processador do dispositivo sempre acordado. Defina apenas se caso contrário você inscrições soltos e NÃO FAZEM receber chamadas',
    sett_comment_short_cpualwayspartiallock_pt:
      'Manter um bloqueio parcial sobre a CPU para evitar o sono profundo',

    sett_display_name_disablewbforpstn_pt: 'Desativar banda larga para PSTN',
    sett_comment_disablewbforpstn_pt:
      'Desativar codecs de áudio de banda larga para chamadas para números móveis / fixos (banda larga apenas para IP para chamadas IP)',
    sett_comment_short_disablewbforpstn_pt: '',

    sett_display_name_multiplecalls_pt: 'Permitir várias chamadas',
    sett_comment_multiplecalls_pt:
      'Permitir várias chamadas de conferência / (CPU low-end não é capaz de lidar com)',
    sett_comment_short_multiplecalls_pt: '',

    sett_display_name_callbacknumber_pt: 'Número de retorno',
    sett_comment_callbacknumber_pt:
      'Número de acesso de retorno de chamada. Alguns provedores de serviços VoIP fornecer este tipo de número que você pode tocar e receber chamada de entrada de IVR servidor',
    ...
    sett_comment_focusaudio_pt:
      'Concentre-se em áudio da chamada de VoIP (isso pode diminuir o volume de outros fluxos, como o seu media player enquanto você está falando sobre VoIP)',
    sett_comment_short_focusaudio_pt: 'Concentre-se em áudio VoIP',

    sett_display_name_useroutingapi_pt: 'Use API roteamento',
    sett_comment_useroutingapi_pt:
      'Use API roteamento por razões de compatibilidade. Alguns dispositivos -normalmente de idade- pode precisar deste para a manipulação de áudio correto',
    sett_comment_short_useroutingapi_pt: '',

    sett_display_name_hardwaremedia_pt: 'Media de hardware',
    sett_comment_hardwaremedia_pt:
      'Use melhorias de mídia de hardware, como AEC e denoise. Isto pode adicionar um ligeiro atraso para os fluxos de áudio',
    ...
    sett_comment_nativefilterblock_pt:
      'NÃO FAZEM lidar com as chamadas nativas se o número começa a sagacidade',
    sett_comment_short_nativefilterblock_pt: '',

    sett_display_name_integrateifwifionly_pt: 'Integrar se Wi-Fi só',
    sett_comment_integrateifwifionly_pt:
      'Integrar com discador nativo somente se Wifi está conectado',
    ...
    sett_comment_natopenpackets_pt:
      'pacotes UDP para enviar para abrir o dispositivo NAT (mudança, se você tem problemas de NAT)',
    ...
    sett_comment_transfwithreplace_pt:
      'Especificar se substituir deve ser usado com a transferência de modo que a chamada velha (de diálogo) não está desligado, mas apenas substituído. Desta forma, o A festa nunca é desligado, apenas a parte chamada é alterado. A uma parte deve ser capaz de lidar com o cabeçalho substituir para isso',
    sett_comment_short_transfwithreplace_pt:
      'Especificar se substituir deve ser usado com a transferência de modo que a chamada velha (de diálogo) não está desligado, mas apenas substituído',
    ...
    sett_comment_submenu_integrate_pt:
      'Ao discar com discador nativo você vai ser perguntado se você quiser usar SIP ou móveis',
    ...
    logview_help_de:
      'Kopieren Sie den Inhalt der Protokolle Fenster und senden Sie es in einem EMail zu:',
    ...
    no_contacts_2_de:
      'Oder verwenden Sie die "Sync Kontakt" Menü-Option um Kontakte aus Ihrem Handy zu importieren.<br />(Sync funktioniert nur, nachdem Sie Kontakte aus Ihrem Handy hochgeladen haben)',
    ...
    ie_update_de:
      'Diese Anwendung erfordert eine höhere Version von Internet Explorer . Wollen Sie die Aktualisierung downloadnen?',
    ...
    ce_enablejava_de:
      '<a href="https://java.com/en/download/help/enable_browser.xml" target="_blank">aktiviere Java in den Browsereinstellungen </a>',
    ce_install_java_de:
      'Falls Java noch nicht installiert ist, installieren Sie es von <a href="https://java.com/download/" target="_blank">here.</a>',
    ...
    np_install_msg_de:
      'Downloaden Sie das Service Plugin und installieren Sie es.<br />Clicken Sie auf OK oder ABBRUCH.',
    ...
    java_install_de:
      'Klicken Sie auf OK, um Java herunterzuladen.<br>Sie muessen Sich wieder neu anmelden , nachdem Sie die Installation beendet haben.',
    ...
    hint_phone_number_de:
      'Geben Sie hier die Telefonnummer, SIP-Account, Benutzernamen oder SIP-URI ein.',
    ...
    connection_msg_de:
      'Es scheint, dass Sie nicht mit dem Internet verbunden sind.<br>Bitte überprüfen Sie die Verbindung.',
    ...
    warning_feature_de:
      'Sie benötigen einen Pro-Lizenz fuer diese Funktion. <br /> um diese Lizenz zu aktivieren, loggen Sie sich zuerst ein, dann waehlen Sie -Lizenz- aus dem Menue.',
    allowmedia_title_de: 'Zugang zu den Medien',
    allowmedia_chrome_de:
      'Das benoetigt Zugriff auf das Mikrofon. <br /> Um Zugriff zu gewaehren, klicken Sie auf das "Sound" Symbol in der oberen rechten Ecke des Browsers und waehlen  -"erlauben" , dann wiederholen Sie den Anruf',
    allowmedia_firefox_de:
      'Das benoetigt Zugriff auf das Mikrofon. <br /> Um Zugriff zu gewaehren, klicken Sie auf das "Mikrofon" -Symbol oben in der Mitte des Browser und wählen Sie "erlauben", dann wiederholen Sie den Anruf.',
    allowmedia_general_de:
      'das benoetigt Zugriff auf das Mikrofon. <br /> Nachdem Sie den Zugriff gewaehrt haben, wiederholen Sie den Anruf.',
    ...
    chrome_local_alert_de:
      'Das Webphone unterstuetzt das Arbeiten mit dem lokalen Dateisystem in Google Chrome oder Opera-Browser nicht.  Sie muessen es auf einem Webserver bereitstellen. Sie können Firefox oder IE verwenden wenn sie mit dem lokalen Dateisystem arbeiten wollen.',
    chrome_local_webrtc_audio_de:
      'WebRTC hat keine Berechtigung für den Zugriff auf Audiogeraete aus dem lokalen Dateisystem in Chrome und Opera-Browser.  Das Webphone muss auf auf einem sicheren Webserver (HTTPS) gehostet sein um Anrufe zu taetigen und empfangen mit WebRTC..',
    ...
    chrome_https_de:
      'Fuer Chrome und Opera empfehlen wir das Webphone auf einem sicheren (https) Server zu hosten , sonst wird WebRTC nicht funktionieren.',
    ...
    chrome_https_reload_de:
      'Fuer Chrome und Opera gilt WebRTC wird nur von einer sicheren (https) Umgebung aus funktionieren. OK - Klicken Sie auf die Seite um RigiTel.ch HTTPS-Proxy neu zu laden.',
    all_demo_msg_de:
      '(these messages are displayed only in demo version, in final build these situations are handled automatically)',
    ...
    filter_warning_de:
      'Beim naechsten "Starten mit" oder "Ersetzen durch " Feld eingegeben werden muss.',
    ...
    java_freeze_ff_de:
      'Nachdem Sie zugestimmt haben, diese Anwendung auszufuehren,  nKlicken Sie OK, um fortzufahren',
    ...
    hint_more_de: 'mehr',
    ce_ask_user_de:
      'Es scheint als ob [SELECTEDENGINE] Engine nicht funktioniert. Sollen wir [RECOMMENDED] Engine ausprobieren?',
    ...
    username_err_de:
      'Der Benutzername enthaelt nicht unterstuetzte Sonderzeichen, bitte umschreiben',
    ...
    webcallme_msg_de:
      'Senden Sie diesen Link an Ihre Freunde, damit Sie sie mit einem einfachen Klick anrufen koennen.',
    ...
    service_update_de:
      'Eine neue Version von NS-Service Plugin zur Verfuegung. Es ist empfohlen auf die neueste Version zu aktualisieren..',
    ...
    logview_msg_de:
      'Wenn sich nach einigen Sekunden nichts aendert, aktualisiren Sie die Seite manuell..',
    messagepl_de: 'schreibe',
    unlockadvancedsett_title_de: 'Einstellungen freigeben',
    unlockadvancedsett_msg_de:
      'Geben Sie das Kennwort ein um die erweiterten Einstellungen zu entsperren',
    ...
    warning_msg_1_de:
      'Nur direkte Anrufe auf URIs zu SIP sind möglich, wenn die VoIP-Server-Adresse nicht gesetzt ist.',
    warning_msg_2_de:
      'IP oder Domain-Name wird in dieser Version nicht akzeptiert. Geben Sie den Servernamen oder ID hier ein.',
    warning_msg_3_de: 'Bitte geben Sie den Namen des Kontakts ein.',
    warning_msg_4_de:
      'Fehlgeschlagene Konfigurationen abrufen. <br /> <br /> Auf der Seite Einstellungen Server-Eingang, geben Sie die Domaene des VoIP-Provider und Namen oder die IP-Adresse ein',
    ...
    err_flash_local_de:
      'Flash-Engine funktioniert nur, wenn von einem Webserver gestartet, nicht aus lokalen Dateisystem',
    ...
    use_fast_ice__no_de:
      'Nein (auf 0 setzen, wenn Ihr Server immer ueber die Medien geroutet wird)',
    ...
    sett_comment_serveraddress_user_de:
      'Enter server adress (domain or IP:port), brand-name or op-code here',
    ...
    sett_comment_startonboot_de:
      'Laeuft immer für eingehende Anrufe (Service laeuft im Hintergrund, damit eingehende Anrufe empfange werden koennen)',
    ...
    sett_comment_register_de:
      'Registrieren Sie die Domain. Dies ist immer erforderlich, um eingehende Anrufe zu empfangen. Einige Anbieter verlangen das auch für ausgehende Anrufe.',
    ...
    sett_comment_filters_de:
      'Ziel hinzufügen Anzahl Rewrite Regeln (Hinzufügen/Entfernen/rewrite Präfix)',
    ...
    sett_comment_calltimeout_de:
      'Maximum speech time allowed in seconds. Default is 10800 seconds which means 3 hours',
    sett_comment_short_calltimeout_de: '',

    sett_display_name_username_de: 'Caller ID',
    sett_comment_username_de:
      'This will not be used for authentication. Specify if not the same with the Username for authentication setting. Some VoIP servers will reject if not the same with the username!',
    sett_comment_short_username_de:
      'You might set a different username here used for A number display',

    sett_display_name_displayname_de: 'Display name',
    sett_comment_displayname_de:
      'Specify display name. This is an optional setting and it should be your full name',
    ...
    sett_comment_usetunneling_1_de:
      'Useful in VoIP blocked countries and from behind firewalls. If you need to use this feature for more than a few calls, then you should upgrade to MizuDroidPro which includes unlimited tunneling service.',
...
*/
    ...
    sett_comment_savetocontacts_de:
      'Whether to (automatically) add new unknown called numbers to your contact list',
    ...
    sett_comment_doublesendrtp_de:
      'Might improve audio quality in certain circumstances, but will increase upload data amount',
    sett_comment_short_doublesendrtp_de: 'Double send RTP packets',

    sett_display_name_cfgcpuspeed_de: 'CPU Speed',
    sett_comment_cfgcpuspeed_de:
      'Features such as AEC or codec are turned on/off based on your device processor speed',
    sett_comment_short_cfgcpuspeed_de:
      'Features are selected automatically based on your CPU speed',

    sett_display_name_cfgnetworkspeed_de: 'Network Speed',
    sett_comment_cfgnetworkspeed_de:
      'Helps to choose the best codec and media enhancements for your calls.',
    ...
    sett_comment_changesptoring_de:
      "Treat session progress (183) responses as ringing (180). This might be required if your service provider doesn't send ringing nor early media",
    ...
    sett_comment_customsipheader_de:
      'Set a custom sip header (a line in the SIP signaling) that will be sent with all SIP messages (Expert setting)',
    ...
    sett_comment_audiobufferlength_de:
      '-1 means auto. Valid values are between 160 and 16000. Expert setting.',
    ...
    sett_comment_displaynotification_de:
      'Show notifications in phone notification bar (usually on the top corner of your phone)',
    ...
    sett_comment_natopenpackets_de:
      'UDP packets to send to open the NAT device (change if you have NAT issues)',
    ...
    sett_comment_transfwithreplace_de:
      'Specify if replace should be used with transfer so the old call (dialog) is not disconnected but just replaced. This way the A party is never disconnected, just the called party is changed. The A party must be able to handle the replace header for this.',
    sett_comment_short_transfwithreplace_de:
      'Specify if replace should be used with transfer so the old call (dialog) is not disconnected but just replaced.',
    ...
    sett_comment_submenu_integrate_de:
      "When dialing with native dialer you'll be asked if you want to use SIP or mobile",
  ...
  var stringres = {
    get: function(resName) {
      if (typeof resName === 'undefined' || resName === null) {
        return ''
      }
      ...
      if (typeof lan === 'undefined' || lan === null || lan.length < 1) {
        try {
          if (console && console.log) {
            console.log('ERROR, invalid language: ' + lan)
          }
        } catch (e) {}
        return
      }
