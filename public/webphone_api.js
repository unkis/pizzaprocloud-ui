...
var webphone_api = (function() {
   ...
   * Note: you can initiate calls also from the onLoaded and it will be queued to be executed after onStart.
   * (no parameters) */
  ...
  /** Call this function once, passing a callback.
   * The passed callback function will be called when the webphone SIP client is successfully registered (connected) to the VoIP server.
   * (no parameters) */
  ...
  function start() {
    if (typeof plhandler === 'undefined' || plhandler === null) {
      ...
      return false
    } else return plhandler.Start(parameters, true)
  }
  ...
  function stop() {
    ...
    else plhandler.Stop(parameters)
  }
  ...
  function register() {
    ...
    else plhandler.Register(parameters)
  }
  ...
  function registerex(accounts) {
    ...
    else plhandler.RegisterEx(accounts)
  }
  ...
  function videocall(number) {
    ...
    else plhandler.VideoCall(number)
  }
  ...
  function mutevideo(state, direction) {
    ...
    else plhandler.MuteVideo(state, direction)
  }
  ...
  function setvideodisplaysize(type, width, height) {
    ...
    else plhandler.SetVideoSize(type, width, height)
  }
  ...
  function screenshare(number, screenid) {
    ...
    else plhandler.ScreenShare(number, screenid)
  }
  ...
  function stopscreenshare() {
    ...
    else plhandler.StopScreenShare()
  }
  ...
  function getregfailreason(callback, extended) {
    ...
    else webphone_api.Log('ERROR, webphone_api: getregfailreason plhandler is not defined')
  }
  ...
  function playsound(
    ...
    else webphone_api.Log('ERROR, webphone_api: playsound plhandler is not defined')
    return false
  }
  ...
  function conference(number, add) {
    ...
    else plhandler.Conference(number, add)
  }
  ...
  function transfer(number) {
    ...
    else plhandler.Transfer(number)
  }
  ...
  function mute(state, direction) {
    ...
    else return plhandler.MuteEx(state, direction)
  }

  /** Will return true if the call is muted, otherwise false */
  function ismuted() {
    if (typeof plhandler !== 'undefined' && plhandler !== null) return plhandler.IsMuted()
    else return false
  }
  ...
  function hold(state) {
    ...
    else return plhandler.Hold(state)
  }

  /** Will return true if the call is on hold, otherwise false */
  function isonhold() {
    if (typeof plhandler !== 'undefined' && plhandler !== null) return plhandler.IsOnHold()
    else return false
  }
  ...
  function sendchat(number, msg) {
    ...
    else plhandler.SendChat(number, msg)
  }
  ...
  function sendsms(number, msg, from) {
    ...
    else plhandler.SendSms(number, msg, from)
  }
  ...
  function voicerecord(start, url) {
    if (typeof plhandler !== 'undefined' && plhandler !== null) plhandler.Voicerecord(start, url)
  }

  /** Open audio/video device selector dialog (built-in user interface).*/
  function devicepopup() {
    if (typeof plhandler !== 'undefined' && plhandler !== null) plhandler.DevicePopup()
  }
  ...
  function getdevice(dev, callback) {
    if (typeof plhandler !== 'undefined' && plhandler !== null) plhandler.GetDevice(dev, callback)
  }
  ...
  function setvolume(dev, volume) {
    if (typeof plhandler !== 'undefined' && plhandler !== null) plhandler.SetVolume(dev, volume)
  }
  ...
  function getvolume(dev, callback) {
    if (typeof plhandler !== 'undefined' && plhandler !== null) plhandler.GetVolume(dev, callback)
  }
  ...
  function setloudspeaker(set) {
    if (typeof plhandler !== 'undefined' && plhandler !== null) plhandler.SetLoudspeaker(set)
  }
  ...
  function listcontacts(all) {
    if (typeof plhandler !== 'undefined' && plhandler !== null) return plhandler.ListContacts(all)
  }
  ...
  function listcallhistory() {
    if (typeof plhandler !== 'undefined' && plhandler !== null) return plhandler.ListCallhistory()
  }

  /** Any additional parameters must be set before start/register/call is called*/
  function setparameter(param, value) {
    if (typeof param === 'undefined' || param === null || typeof value === 'undefined') {
      return false
    }
  ...
  function setline(line) {
    if (typeof plhandler !== 'undefined' && plhandler !== null) plhandler.SetLine(line)
  }
  ...
  function isregistered() {
    // boolean
    if (typeof plhandler !== 'undefined' && plhandler !== null) return plhandler.IsRegistered()
    else return false
  }
  ...
  function isincall() {
    // boolean
    if (typeof plhandler !== 'undefined' && plhandler !== null) return plhandler.IsInCall()
    else return false
  }

  /** Unregister SIP account from VoIP server*/
  function unregister() {
    if (typeof plhandler !== 'undefined' && plhandler !== null) plhandler.Unregister()
  }
  ...
  function checkblf(userlist) {
    if (typeof plhandler !== 'undefined' && plhandler !== null) return plhandler.CheckBLF(userlist)
  }

  /** Check if communication channel is encrypted: -1=unknown, 0=no, 1=partially, 2=yes, 3=always*/
  function isencrypted() {
    if (typeof plhandler !== 'undefined' && plhandler !== null) return plhandler.IsEncrypted()
    else return -1
  }
  ...
  function setsipheader(header) {
    if (typeof plhandler !== 'undefined' && plhandler !== null) plhandler.SetSipHeader(header)
    else webphone_api.Log('ERROR, webphone_api: setsipheader plhandler is not defined')
  }
  ...
  function getsipheader(header, callback) {
    ...
    else webphone_api.Log('ERROR, webphone_api: getsipheader plhandler is not defined')
  }
  ...
  function getsipmessage(dir, type, callback) {
    ...
    else webphone_api.Log('ERROR, webphone_api: getsipmessage plhandler is not defined')
  }
  ...
  function getworkdir(callback) {
    ...
    else return 'ERROR, getworkdir plhandler is not defined'
  }
  ...
  function delsettings(level) {
    if (typeof plhandler !== 'undefined' && plhandler !== null) plhandler.delsettings(level)
    else webphone_api.Log('ERROR, webphone_api: delsettings plhandler is not defined')
  }
  ...
  function getenginename() {
    if (typeof plhandler !== 'undefined' && plhandler !== null) return plhandler.Getenginename()
    else webphone_api.Log('ERROR, webphone_api: getenginename plhandler is not defined')
  }
  ...
  function getlastinvite(callback) {
    ...
    else return 'ERROR, getlastinvite plhandler is not defined'
  }
  ...
  function getlogs() {
    if (typeof plhandler !== 'undefined' && plhandler !== null) return plhandler.getlogs()
    else webphone_api.Log('ERROR, webphone_api: getlogs plhandler is not defined')
  }
  ...
  function jvoip(name, jargs) {
    if (typeof plhandler !== 'undefined' && plhandler !== null) plhandler.Jvoip(name, jargs)
    else webphone_api.Log('ERROR, webphone_api: jvoip plhandler is not defined')
  }
  ...
  function getStatus() {
    // string
    if (typeof plhandler === 'undefined' || plhandler === null) return 'STATUS,-1,Initializing'
    else return plhandler.GetStatus()
  }
  ...
  function loadscript(url, async, attrname, attrval) {
    ...
    Log = function(msg) {
      try {
        ...
        if (console && console.log) {
          if (console.error && msg.toLowerCase().indexOf('error') > -1) {
            console.error(msg)
          } else {
            console.log(msg)
          }
    ...
    try {
      ...
      LogEx('webphone_api LoadScript', err)
    }
  }
...
webphone_api.getbasedir2 = function(forceauto) {
  try {
    if (forceauto !== true) {
      ...
      if (typeof wpbdir === 'undefined' || wpbdir === null || wpbdir === '.' || wpbdir.length < 2) {
        wpbdir = ''
      }
          ...
          if (webphone_api.bd_logged !== true) {
            try {
              if (
                ...
                console.log('base diectory - webphonebasedir(guessed): ' + wpbdir)
              }
            } catch (err) {}
          }
          webphone_api.bd_logged = true
...
document.write(
  '<script type="text/javascript" src="' +
    webphone_api.getbasedir2() +
    'js/lib/api_helper.js"></script>',
)
