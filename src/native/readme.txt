Medianch for webphone and java.

This folder contains optional platform dependent native binaries for the VoIP engine.
Just copy these files in your native folder or the jar (unzip and copy the files near the webphone.jar or JVoIP.jar)


DETAILS:

The webphone/JVoIP will work fine also without these files, but having them accessible might increase the voice quality.
